...
namespace QA_testing_project
{
    ...
    public class Testcases : TestBase
    {
        ...
        static object[] TestData = { "Maks", "@#Q@EDQAW", "AnaK0ND4", "RePoSitOry", "delete * from owners" };
       ...
       // [Parallelizable]
        ...
        public void testcase1(string NaMe)
        {
            ...
            Pages.OwnerPage.ChangeFirstNameValue(NaMe);
       ...
       // [Parallelizable]
        ...
        [Test, Description("This test trying to add veterinarian")]
        ...
        {
            Pages.vetPage.NavigationComponent.OpenVetTab();
            Pages.vetPage.NavigationComponent.OpenVetCreateTab();
            Pages.vetPage.ChangeFirstNameValue(name);
            Pages.vetPage.ChangeLastNameValue("Artist");
...
public static IEnumerable TestCases1
    {
        get
        {
            yield return new TestCaseData("Maksym");
            yield return new TestCaseData("Petro");
            yield return new TestCaseData("Lord");
            yield return new TestCaseData("Olga");
        }
    }
}