    ...
    public class PetTypesPage : page_object
     {
        ...
        public void ClickAddPetButton() => driver.FindElement(By.CssSelector(".addPet")).Click();

        public void ChangeNameValue(string value, bool overwrite = true) => ChangeInputValue(By.Id("name"), value, overwrite);

        public void ConfirmAddButton() => driver.FindElement(By.CssSelector(".saveType")).Click ();
